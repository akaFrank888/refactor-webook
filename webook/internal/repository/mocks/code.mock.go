...
// Source: ./webook/internal/repository/wechat.go
//
// Generated by this command:
//
//	mockgen -source=./webook/internal/repository/wechat.go -package=repomocks -destination=./webook/internal/repository/mocks/code.mock.go
//
